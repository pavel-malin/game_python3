# Шифр Цезаря
SYMBOLS = 'АБВГДЕЁЖЗИЙКЛМНОПРСТУФХЦЧШЩЪЫЬЭЮЯабвгдеёжзийклмнопрстуфхчшщъыьэюя'
...
def getMode():
    while True:
        ...
        if mode in ['зашифровать', 'з', 'расшифровать', 'р']:
            ...
            print("Введите 'зашифровать' или 'з' для зашифровки или \
                   'расшифровать' или 'р' для расшифровки.")
