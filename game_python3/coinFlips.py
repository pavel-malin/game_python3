...
print('Я подброшу монетку 1000 раз. Угадай, сколько раз выпадает \
       "Орел"? ' + '(Жми клавишу Enter, чтобы начать)')
input()
flips = 0
heads = 0
while flips < 1000:
...
print()
print('Из 1000 подбрасываний монеты "Орел" выпал' + str(heads) + ' раз!')
