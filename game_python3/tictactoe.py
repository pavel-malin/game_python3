...
def drawBoard(board):
    # Эта функция выводит на экран игровое поле, клетки которого будет заполняться.
...
def inputPlayerLetter():
    # Разрешение игроку ввести букву, которую он выбрает.
    # Возвращает список, в котором буква игрока - первый элемент, а буква компьтера - вторая.
    letter = ''
    while not (letter == 'X' or letter == 'O'):
        print('Вы выбираете Х или О?')
        letter = input().upper()

    # Первым элементом списка является буква игрока, вторым - буква компьтера.
    if letter == 'X':
        return ['X', 'O']
    else:
        return ['O', 'X']
...
def isWinner(bo, le):
    ...
    return ((bo[7] == le and bo[8] == le and bo[9] == le) or # across the top
            ...
            (bo[9] == le and bo[6] == le and bo[3] == le) or # вниз пл правой стороне
...
def getComputerMove(board, computerLetter):
    ...
    # Это алгоритм для ИИ "Крестики-Ноликов":
