...
HANGMAN_PICS = ['''
   ...
   / \  |
       ===''']
words = 'grass stork shark baboon ram badger beaver bull rerbuled wolf \
         sparrow raven otter pigeon goose toad zebra snake turkey whale \
         goat goat goat coyote cow cat rabbit rat chicken lama weasel swan \
         lion fox salmon elk frog bear clam moth mole yrrke moo spider \
         python parrot puma salmon skunk dog ova tiger triton seal duck \
         trout ferret turtle hawk lizard'.split()
...
def getGuess(alreadyGuessed):
    # Returns the letter entered by the player. This function checks that
    # the player has entered only one letter and nothing else.
    while True:
