...
words = {'Colors': 'red orange yellow green blue indigo violet white black \
         ...
         'Animals': 'bat bear beaver cat cougar crab deer dog donkey duck \
          eagle fish frog goat leech lion lizard monkey moose mouse otter \
          owl panda python rabbit rat shark sheep skunk squid tiger turkey \
