...
drawText('Ловкач', font, windowSurface, (WINDOWWIDTH / 3),
         (WINDOWHEIGHT / 3))
drawText('Нажмите клавишу для начала игры.', font, windowSurface,
    ...
    while True:  # Игровой цикл выполняется, пока игра работает.
        ...
        for event in pygame.event.get():
            ...
            if event.type == MOUSEMOTION:
                ...
                # Если необходимо, добавить новых злодеев в верхнюю часть
                # экрана.
            ...
            windowSurface.fill(BACKGROUNDCOLOR)
            # Отображение количкства очков и лучшего результата.
        ...
        drawText('ИГРА ОКОНЧЕНА!', font, windowSurface, (WINDOWWIDTH / 3),
                 (WINDOWHEIGHT / 3))
        drawText('Нажмите клавишу для начала новой игры',
                 font,
                 windowSurface,
                 (WINDOWWIDTH / -120),
                 (WINDOWHEIGHT / 3) + 50)
